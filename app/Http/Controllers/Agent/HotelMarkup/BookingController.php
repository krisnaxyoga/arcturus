...
class BookingController extends Controller
{
    public function create(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            foreach($roomData as $item){
                ...
                $noagt = str_replace(',','',$item['noagentmarkup']);

                // Konversi string harga menjadi angka (integer)
                $priceint = (int) $string;

                $amountnoagentmarkup = (int) $noagt;
                ...
                $noagentmarkup += $amountnoagentmarkup;
            }
    ...
    public function detail($id)
    {
        ...
        return view('landingpage.agent.bookingpage',compact('data','hotelbooking','transport','destination'));
    }
    ...
    public function bookingstore(Request $request, string $id)
    {
        // dd($request->totalPrice);
            ...
            if ($validator->fails()) {
                ...
                return view('landingpage.agent.transferbank',compact('booking','total_as_saldo','transportbooking'));
            }
            return redirect()
    ...
    public function pay($id)
    {
        ...
        if($saldo >= $total_as_saldo){
            ...
            return view('landingpage.agent.confirsaldo',compact('message'));
        }else{
